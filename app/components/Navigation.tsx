...
export default function Navigation({
  ...
  return (
    <div className="bg-white border-b border-[#E2E8F0] sticky top-0 z-30">
      ...
      <div className="max-w-7xl mx-auto px-4 py-2 relative z-40">

        <div className="flex flex-nowrap items-center justify-between">
          
          {/* Contenedor visible sin recortes */}
          <div 
            className="flex flex-nowrap items-center gap-1 overflow-visible pb-2"
          >
