    ...
    try {
      ...
      if (creandoCategoria) {
        ...
        if (categoriaExistente) {
          alert(
            `La categoría "${categoriaExistente}" ya existe. Selecciónala de la lista.`
          )
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            <div>
              ...
              <p className="text-sm text-[#64748B] mt-1">
                Resumen general de Barberworld
              </p>
            </div>
            ...
            <>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-extrabold text-[#12283F] mt-2">
                        {pedidosTotales}
                      </p>
                    </div>

                    <div className="w-10 h-10 rounded-lg bg-[#F5F7FA] flex items-center justify-center text-lg">
                      🛒
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
                ...
                <div className="lg:col-span-2 bg-white rounded-xl border border-[#E2E8F0] p-6 shadow-sm">
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <h3 className="font-bold text-[#12283F]">
                        Ventas últimos 7 días
                      </h3>
              ...
              <div className="bg-white rounded-xl border border-[#E2E8F0] p-6 shadow-sm mt-5">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <Link
                    href="/admin/pedidos"
                    className="text-xs font-semibold text-[#12283F] hover:underline"
                  >
                    Ver todos →
                  </Link>
                </div>
                        ...
                        {pedidos
                          ...
                          .map(
                            (pedido) => (
                              ...
                              >
                                <div>
                                  <p className="text-sm font-semibold text-[#12283F]">
                                    {
                                ...
                                <p className="text-sm font-extrabold text-[#12283F]">
                                  {formatearPrecio(
                                    pedido.total
                                  )}
                                </p>
        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-xs text-[#94A3B8] mt-1">
                Gestiona el catálogo de Barberworld
              </p>
            </div>
                ...
                (product) => (
                  ...
                  >
                    ...
                    <div className="aspect-square bg-[#F5F7FA] relative overflow-hidden shrink-0">
                      ...
                      {!product.activo && (
                        <span className="absolute top-2 left-2 bg-[#12283F] text-white text-[10px] font-semibold uppercase tracking-wide px-2 py-0.5 rounded">
                          Inactivo
                        </span>
                      )}
                    </div>
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      <div className="mt-auto pt-4 border-t border-[#E2E8F0] space-y-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-semibold text-[#334155] leading-none">
                            {product.activo
                              ? 'Activo'
                              : 'Inactivo'}
                          </span>
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 text-center text-[#12283F] text-xs font-semibold border border-[#CBD5E1] rounded-lg py-1.5 hover:bg-[#F5F7FA] transition-colors"
                          >
                            Editar
                          </button>
                          ...
                          <button
                            ...
                            className="flex-1 text-center text-red-600 text-xs font-semibold border border-red-200 rounded-lg py-1.5 hover:bg-red-50 transition-colors"
                          >
                            Eliminar
                          </button>
                        </div>
